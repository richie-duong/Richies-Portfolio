...
export const Projects = () => {
    ...
    const goToGithub = () => {
        window.location.href = 'https://github.com/richie-duong'
    }
        ...
        <>
            <div className='section-container'>
                ...
                <ul className='projects-list'>
                    <div className='left'>
                        <li>
                            <a href="https://github.com/richie-duong/First-NodeJS-Project" target="_blank"><h3><strong>Node.js CRUD / Data Analysis App</strong></h3></a>
                        ...
                        <li>
                            <a href="https://github.com/richie-duong/Jeopardy" target="_blank"><h3><strong>Jeopardy Trivia Game</strong></h3></a>
                    ...
                    <div className='right'>
                        <li>
                            <a href="https://github.com/richie-duong/Family-Feud" target="_blank"><h3><strong>Family Feud Trivia Game</strong></h3></a>
                            <div className='lang-icons'><h2><SiJavascript /> <GrReactjs /> <FaNode /> <SiMongodb /></h2></div>
                        ...
                        <li id='github-intro'>
                            ...
                            <Button variant="outline-light" onClick={goToGithub}>View Complete Repository</Button>
                        </li>
                    </div>
                </ul>
            </div>
